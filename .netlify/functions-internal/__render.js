...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-b990e79e.js",
      css: [assets + "/_app/assets/start-d5b4de3e.css"],
      js: [assets + "/_app/start-b990e79e.js", assets + "/_app/chunks/vendor-6e21d1eb.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/products/distributors/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/products/feed-bodies/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/products/conveyors/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/products/elevators/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/products/catwalks/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/products/mixers/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/services\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/feed-body-repairs/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/hot-dipped-steel/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/manufacturing/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/truck-repairs/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/machine-shop/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/sandblasting/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/consulting/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/drafting/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/painting/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/waterjet/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/parts/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      ...
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/services/road/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
    ...
    },
    {
      ...
      pattern: /^\/vendors\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/vendors/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/products/distributors/index.svelte": () => Promise.resolve().then(function() {
    return index$l;
  }),
  "src/routes/products/feed-bodies/index.svelte": () => Promise.resolve().then(function() {
    return index$k;
  }),
  "src/routes/products/conveyors/index.svelte": () => Promise.resolve().then(function() {
    return index$j;
  }),
  "src/routes/products/elevators/index.svelte": () => Promise.resolve().then(function() {
    return index$i;
  }),
  "src/routes/products/catwalks/index.svelte": () => Promise.resolve().then(function() {
    return index$h;
  }),
  "src/routes/products/mixers/index.svelte": () => Promise.resolve().then(function() {
    return index$g;
  }),
  "src/routes/services/index.svelte": () => Promise.resolve().then(function() {
    return index$f;
  }),
  "src/routes/services/feed-body-repairs/index.svelte": () => Promise.resolve().then(function() {
    return index$e;
  }),
  "src/routes/services/hot-dipped-steel/index.svelte": () => Promise.resolve().then(function() {
    return index$d;
  }),
  "src/routes/services/manufacturing/index.svelte": () => Promise.resolve().then(function() {
    return index$c;
  }),
  "src/routes/services/truck-repairs/index.svelte": () => Promise.resolve().then(function() {
    return index$b;
  }),
  "src/routes/services/machine-shop/index.svelte": () => Promise.resolve().then(function() {
    return index$a;
  }),
  "src/routes/services/sandblasting/index.svelte": () => Promise.resolve().then(function() {
    return index$9;
  }),
  "src/routes/services/consulting/index.svelte": () => Promise.resolve().then(function() {
    return index$8;
  }),
  "src/routes/services/drafting/index.svelte": () => Promise.resolve().then(function() {
    return index$7;
  }),
  "src/routes/services/painting/index.svelte": () => Promise.resolve().then(function() {
    return index$6;
  }),
  "src/routes/services/waterjet/index.svelte": () => Promise.resolve().then(function() {
    return index$5;
  }),
  "src/routes/services/parts/index.svelte": () => Promise.resolve().then(function() {
    return index$4;
  }),
  "src/routes/services/road/index.svelte": () => Promise.resolve().then(function() {
    return index$3;
  }),
  "src/routes/contact/index.svelte": () => Promise.resolve().then(function() {
    return index$2;
  }),
  "src/routes/vendors/index.svelte": () => Promise.resolve().then(function() {
    return index$1;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-11932b3c.js", "css": ["assets/pages/__layout.svelte-f89ecc7b.css"], "js": ["pages/__layout.svelte-11932b3c.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-67de73f4.js", "css": [], "js": ["error.svelte-67de73f4.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-b867be12.js", "css": ["assets/pages/index.svelte-d627191e.css"], "js": ["pages/index.svelte-b867be12.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/products/index.svelte": { "entry": "pages/products/index.svelte-eb697801.js", "css": [], "js": ["pages/products/index.svelte-eb697801.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/products/distributors/index.svelte": { "entry": "pages/products/distributors/index.svelte-9ed487b2.js", "css": [], "js": ["pages/products/distributors/index.svelte-9ed487b2.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/products/feed-bodies/index.svelte": { "entry": "pages/products/feed-bodies/index.svelte-8bf11c60.js", "css": [], "js": ["pages/products/feed-bodies/index.svelte-8bf11c60.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/products/conveyors/index.svelte": { "entry": "pages/products/conveyors/index.svelte-f03c7acd.js", "css": [], "js": ["pages/products/conveyors/index.svelte-f03c7acd.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/products/elevators/index.svelte": { "entry": "pages/products/elevators/index.svelte-9b1e1c9c.js", "css": [], "js": ["pages/products/elevators/index.svelte-9b1e1c9c.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/products/catwalks/index.svelte": { "entry": "pages/products/catwalks/index.svelte-b2d123a7.js", "css": [], "js": ["pages/products/catwalks/index.svelte-b2d123a7.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/products/mixers/index.svelte": { "entry": "pages/products/mixers/index.svelte-99274ad3.js", "css": [], "js": ["pages/products/mixers/index.svelte-99274ad3.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/services/index.svelte": { "entry": "pages/services/index.svelte-46434887.js", "css": [], "js": ["pages/services/index.svelte-46434887.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/feed-body-repairs/index.svelte": { "entry": "pages/services/feed-body-repairs/index.svelte-ed2a1f7e.js", "css": [], "js": ["pages/services/feed-body-repairs/index.svelte-ed2a1f7e.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/hot-dipped-steel/index.svelte": { "entry": "pages/services/hot-dipped-steel/index.svelte-8f7ded28.js", "css": [], "js": ["pages/services/hot-dipped-steel/index.svelte-8f7ded28.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/services/manufacturing/index.svelte": { "entry": "pages/services/manufacturing/index.svelte-9fd91410.js", "css": [], "js": ["pages/services/manufacturing/index.svelte-9fd91410.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/truck-repairs/index.svelte": { "entry": "pages/services/truck-repairs/index.svelte-9eb03a60.js", "css": [], "js": ["pages/services/truck-repairs/index.svelte-9eb03a60.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/services/machine-shop/index.svelte": { "entry": "pages/services/machine-shop/index.svelte-0199cee7.js", "css": [], "js": ["pages/services/machine-shop/index.svelte-0199cee7.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/sandblasting/index.svelte": { "entry": "pages/services/sandblasting/index.svelte-489eb0b8.js", "css": [], "js": ["pages/services/sandblasting/index.svelte-489eb0b8.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/consulting/index.svelte": { "entry": "pages/services/consulting/index.svelte-1ade1c12.js", "css": [], "js": ["pages/services/consulting/index.svelte-1ade1c12.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/services/drafting/index.svelte": { "entry": "pages/services/drafting/index.svelte-5c77cffc.js", "css": [], "js": ["pages/services/drafting/index.svelte-5c77cffc.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/painting/index.svelte": { "entry": "pages/services/painting/index.svelte-54ac4f32.js", "css": [], "js": ["pages/services/painting/index.svelte-54ac4f32.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/services/waterjet/index.svelte": { "entry": "pages/services/waterjet/index.svelte-f400118c.js", "css": [], "js": ["pages/services/waterjet/index.svelte-f400118c.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/services/parts/index.svelte": { "entry": "pages/services/parts/index.svelte-28f9ee62.js", "css": [], "js": ["pages/services/parts/index.svelte-28f9ee62.js", "chunks/vendor-6e21d1eb.js"], "styles": [] }, "src/routes/services/road/index.svelte": { "entry": "pages/services/road/index.svelte-e3ff0bc5.js", "css": [], "js": ["pages/services/road/index.svelte-e3ff0bc5.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/contact/index.svelte": { "entry": "pages/contact/index.svelte-bce250cd.js", "css": [], "js": ["pages/contact/index.svelte-bce250cd.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/vendors/index.svelte": { "entry": "pages/vendors/index.svelte-4df576fd.js", "css": ["assets/pages/vendors/index.svelte-3c78839b.css"], "js": ["pages/vendors/index.svelte-4df576fd.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] }, "src/routes/about/index.svelte": { "entry": "pages/about/index.svelte-7c91e947.js", "css": [], "js": ["pages/about/index.svelte-7c91e947.js", "chunks/vendor-6e21d1eb.js", "chunks/featuredImage-88a91375.js"], "styles": [] } };
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <ul class="${"w-full max-w-screen-lg items-center hidden lg:flex"}"><li class="${"inline-block h-full"}"><a href="${"/"}" class="${"inline-block h-5/6 pt-4"}"><img src="${"/logo-bw.webp"}" alt="${"Midwest Welding & Manufacturing Logo"}" class="${"h-full"}"></a></li>
    ...
    ${each(menu_items, (item) => `<li class="${"inline-block h-full text-white hover:text-opacity-70"}"><a${add_attribute("href", item.route, 0)} class="${"h-full flex items-center px-3 text-xl"}"><span>${escape(item.text)}</span></a>
    </li>`)}</ul></nav>
...
<nav class="${["navigation svelte-1lo0i5u", ""].join(" ").trim()}" id="${"off-canvas-nav"}"><a href="${"#a"}" class="${"closebtn svelte-1lo0i5u"}">\xD7</a>
  <ul><li><a href="${"/"}" class="${"svelte-1lo0i5u"}">Home</a></li>
    ${each(menu_items, (item) => `<li><a${add_attribute("href", item.route, 0)} class="${"svelte-1lo0i5u"}">${escape(item.text)}</a></li>`)}</ul></nav>
...
var HomeQuickContact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const contacts = [
    {
      title: "Parts Dept",
...
var ServiceHighligt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const services = [
    {
...
var ServiceRegions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"w-screen bg-white py-24"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg grid grid-cols-1 md:grid-cols-2 mx-auto"}"><div><h2 class="${"text-4xl text-blue font-semibold mb-4"}">MWM Service Regions</h2>
      <ul class="${"text-2xl leading-relaxed"}">${each(regions, (region) => `<li class="${"uppercase"}">${escape(region)}</li>`)}</ul></div>
    <div class="${"mt-5 lg:mt-0"}"><img src="${"/service-regions.webp"}" alt="${"MWM Services the greater Midwest of North America"}"></div></div>
</div>`;
});
var prerender$g = true;
...
${validate_component(ServiceRegions, "ServiceRegions").$$render($$result, {}, {}, {})}

${$$result.head += `${$$result.title = `<title>Home | MWM</title>`, ""}<meta name="${"description"}" content="${"MWM is a custom agricultural equipment manufacturer with 75yrs of providing products and repair services to greater midwest."}" data-svelte="svelte-1o9khjm"><meta name="${"robots"}" content="${"index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"}" data-svelte="svelte-1o9khjm">`, ""}`;
});
...
var FeaturedImage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"w-screen flex flex-col justify-center items-center bg-center"}" style="${"background-image: url(" + escape(imageUrl) + "); aspect-ratio: 16/4.5"}"><div class="${"w-full max-w-screen-lg bg-gray-600 bg-opacity-40 text-center py-12"}">${$$slots.default ? `${slots.default ? slots.default({}) : ``}` : `<h1 class="${"text-white"}">${escape(pageName)}</h1>
      <h2 class="${"text-white"}">${escape(pageTagline)}</h2>`}</div></div>`;
});
var prerender$f = true;
...
var prerender$d = true;
var Feed_bodies = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const content = {
    ...
    <p>Each feed body build includes: variable speed control, 22\u2032 long discharge auger with hanger bearings, LED lights, mud flaps, hydraulic oil, triple hydraulic main pump with direct drive orbital motors, full opening top door, oil cooler, remote control w/electric solenoid manifold valve stainless steel hydraulic tubes, white paint on steel components, and mounting on customer\u2019s truck chassis.</p>`,
    highlights: [
      {
        title: "Remote System",
        content: "You can purchase an all-manual operation truck, but we've found that our remote system is highly popular with the operators. Our remote system allows you complete control from the cab."
      },
      {
        title: "Top Door",
        content: "Our top door was recently redesigned and features a new sealing method and easily to slide motion."
      },
      {
        title: "High Output",
        content: "Our design allows you to unload faster than the competitors."
      }
    ],
    models: {
      title: "Models",
      content: "MWM's Feed Bodies come in 3 distinct models and 4 variations:",
      list: [
        {
          title: "#400 - Belt Bottom",
          variations: [
            "Standard Height",
            "High Cube",
            "High Output Standard Height",
            "High Output High Cube"
          ]
        },
        {
          title: "#5012 - Auger Bottom",
          variations: [
            "Standard Height",
            "High Cube",
            "High Output Standard Height",
    ...
    options: {
      title: "Options",
      content: "Our list is longer than the alphabet!",
      list: [
        {
          title: "Lights",
          options: [
            "LED light in cross auger",
            "Lights under the fenders by axles",
            "LED lights in the bag door compartment",
            "LED oval stop-tail turn lights on rear wall",
            "LED light in valve compartment",
            "Oval turn signals on fenders",
            "LED spotlights (in customer specified location)"
          ]
        },
        {
          title: "Body",
          options: [
            ...
            "Bag doors",
            "Approximately 600-pound flush box",
            "Full length DOT tape",
            "High cube wall sheets",
            "Air wand on top of truck",
            "Hinged rear step on bumper"
          ]
        },
        {
          title: "Other Features",
          options: [
            "Oil Bath for Vertical and Discharge Augers",
            "Air operated top door",
            "Manual split-top door",
            "Air operated split-top door",
            "Discharge Auger up to 32 foot long",
            "Jack shaft gear reduction on slides",
            "Hydraulic slides",
            "Pit dump shut off",
            "Air operated flush box slide",
            "Stainless steel cross auger assembly",
            "Tram",
            "Hot dip galvanized for steel parts",
            "Paint colors for steel parts",
            "Gum rubber sock on discharge",
            "Red vinyl sock on discharge",
            "Customer name cut into bumper",
            "Customer name cut into flush box",
            "Mud flaps in front of pusher axle"
          ]
        }
      ]
    }
  ...
  const gallery = [
    { url: "/products/feed-bodies/019.webp" },
    {
      url: "/products/feed-bodies/100_6720.webp"
    },
    {
      url: "/products/feed-bodies/100_6827.webp"
    },
    {
      url: "/products/feed-bodies/IMG_5056.webp"
    },
    {
      url: "/products/feed-bodies/100_4238.webp"
    },
    {
      url: "/products/feed-bodies/100_6722.webp"
    },
    {
      url: "/products/feed-bodies/20201112_132849.webp"
    },
    {
      url: "/products/feed-bodies/IMG_5266.webp"
    },
    {
      url: "/products/feed-bodies/100_5540.webp"
    },
    {
      url: "/products/feed-bodies/100_6748.webp"
    },
    {
      url: "/products/feed-bodies/FGFB2016-3.webp"
    },
    { url: "/products/feed-bodies/009.webp" },
    {
      url: "/products/feed-bodies/100_5551.webp"
    },
    {
      url: "/products/feed-bodies/100_6751.webp"
    },
    {
      url: "/products/feed-bodies/FGFB2016-7.webp"
    },
    { url: "/products/feed-bodies/028.webp" },
    {
      url: "/products/feed-bodies/100_5669.webp"
    },
    {
      url: "/products/feed-bodies/100_6752.webp"
    },
    {
      url: "/products/feed-bodies/FGFB2016-8.webp"
    },
    { url: "/products/feed-bodies/030.webp" },
    {
      url: "/products/feed-bodies/100_5757.webp"
    },
    {
      url: "/products/feed-bodies/100_6760.webp"
    },
    {
      url: "/products/feed-bodies/FlagwithSemi.webp"
    },
    { url: "/products/feed-bodies/215.webp" },
    {
      url: "/products/feed-bodies/100_5764.webp"
    },
    {
      url: "/products/feed-bodies/100_6765.webp"
    },
    {
      url: "/products/feed-bodies/IMG_3435.webp"
    },
    { url: "/products/feed-bodies/232.webp" },
    {
      url: "/products/feed-bodies/100_6073.webp"
    },
    {
      url: "/products/feed-bodies/100_6767.webp"
    },
    {
      url: "/products/feed-bodies/IMG_3436.webp"
    },
    { url: "/products/feed-bodies/237.webp" },
    {
      url: "/products/feed-bodies/100_6632.webp"
    },
    {
      url: "/products/feed-bodies/100_6771.webp"
    },
    {
      url: "/products/feed-bodies/IMG_3437.webp"
    },
    { url: "/products/feed-bodies/246.webp" },
    {
      url: "/products/feed-bodies/100_6634.webp"
    },
    {
      url: "/products/feed-bodies/100_6772.webp"
    },
    {
      url: "/products/feed-bodies/IMG_3439.webp"
    },
    {
      url: "/products/feed-bodies/100_6718.webp"
    },
    {
      url: "/products/feed-bodies/100_6822.webp"
    },
    {
      url: "/products/feed-bodies/IMG_3441.webp"
    }
  ];
  return `${validate_component(FeaturedImage, "FeaturedImage").$$render($$result, {
    imageUrl: "'/products/featured-feed-body.webp'",
    pageName: "Bulk Feed Body Trucks",
    pageTagline: "Customizing To Your Needs"
  }, {}, {})}
<div class="${"w-screen flex justify-center py-8"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg"}"><!-- HTML_TAG_START -->${content.featured}<!-- HTML_TAG_END --></div></div>
<div class="${"w-screen flex justify-center py-8 bg-blue"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg text-white"}"><h3>Highlights</h3>
    ${each(content.highlights, (highlight) => `<div><h4>${escape(highlight.title)}</h4>
        <p>${escape(highlight.content)}</p>
      </div>`)}</div></div>
<div class="${"w-screen pb-8 bg-no-repeat bg-center bg-cover text-white"}" style="${"background-image: url(/products/feed-truck-bag-doors.webp)"}"><div class="${"bg-no-repeat bg-center"}" style="${"background-size: 100% 100px; top: 0; content: ''; width: 100%; height: 100px; z-index: 1; background-image: url(data:image/svg+xml;base64,)"}"></div>
  <div class="${"flex justify-center "}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg"}"><h3>${escape(content.models.title)}</h3>
      <p>${escape(content.models.content)}</p>
      <div class="${"grid grid-cols-1 lg:grid-cols-3 gap-4"}">${each(content.models.list, (model) => `<div class="${"bg-red-transparent p-8"}"><h4>${escape(model.title)}</h4>
          ${each(model.variations, (vari) => `<p>${escape(vari)}</p>`)}
        </div>`)}</div></div></div></div>
<div class="${"w-screen py-8 bg-red flex justify-center"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg"}"><h3 class="${"text-white"}">${escape(content.options.title)}</h3>
    <div class="${"bg-white py-5"}"><p class="${"ml-5"}">${escape(content.options.content)}</p>
      <div class="${"mx-5 pt-2"}">${each(content.options.list, (lis) => `<button class="${"py-1 px-3 border-2"}">${escape(lis.title)}</button>`)}</div>
      ${each(content.options.list, (lis) => `${openOption == lis.title ? `<div${add_attribute("id", lis.title, 0)} class="${"border-2 mx-5 mb-5"}"><div class="${"px-8 py-5"}"><ol class="${"list-decimal"}">${each(lis.options, (option) => `<li>${escape(option)}</li>`)}
          </ol></div>
      </div>` : ``}`)}</div></div></div>
...
var Elevators = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var Catwalks = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div>Catwalks/Manwalks</div>`;
});
...
var Mixers = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div>Mixers</div>`;
});
...
var Truck_repairs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var Consulting = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `Consulting`;
});
...
var Parts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `Parts`;
});
...
${$$result.head += `${$$result.title = `<title>Contact | MWM</title>`, ""}<meta name="${"description"}" content="${"Contact MWM for all your custom made agricultural equipment."}" data-svelte="svelte-1qvfenk"><meta name="${"robots"}" content="${"index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"}" data-svelte="svelte-1qvfenk">`, ""}`;
});
...
var css = {
  code: ".list-disc{list-style-type:disc;@apply pl-6;}",
  map: null
};
var prerender$1 = true;
var Vendors = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const vendors = [
    {
      title: "4B Components",
      content: `
        <p>4B Components Ltd. specializes in the manufacture and supply of material handling and electronic components for bucket elevators and conveyors.  Our extensive line of products include:  elevator buckets (plastic/metal), elevator bolts, elevator & conveyor belting, drop forged chain, level indicators, hazard monitors (speed, alignment, temperature) and emergency stop safety switches.</p>
      `,
      image: "/vendors/4b_components.webp",
      link: "https://www.go4b.com/usa/"
    },
    {
      title: "ABB (Dodge)",
      content: `
    ...
    },
    {
      ...
      `,
      image: "/vendors/hayes_stolz.webp",
      link: "https://hayes-stolz.com/"
    },
    {
      title: "Honeyville Metal",
      content: `
      <p>Since 1951 Honeyville Inc. has remained a family owned leader in food ingredient manufacturing. Whether you are a leading food company or a home baking enthusiast, Honeyville has the ingredients and services you need to make your food visions a reality!</p>
      <p>Today, with more than 50 years of experience behind us, we recognize more clearly than ever that our continued success must be built upon relationships of trust with our valued customers. The philosophy of treating people as we would like to be treated still stands as a cornerstone of our corporate vision. People can make a difference \u2026Lowell Sherratt was right!</p>
      `,
      image: "/vendors/honeyville.webp",
      link: "https://www.honeyvillemetal.com/"
    },
    {
      title: "Nolin Milling",
      content: `
      <p>Nolin Milling manufactures bulk material handling equipment and industrial ductwork.</p>
      `,
      image: "/vendors/nolin_milling.webp",
      link: "https://www.nolinmilling.com/"
    },
    {
      title: "Packer Fastener",
      content: `
        <p>Packer Fastener is a Midwest, Business to-Business, Industrial Supply Powerhouse. Packer offers a large, continuously expanding gamut of products including fasteners, abrasives, safety PPE, fittings, welding supplies and other consumable items. Offerings also include a wide array of services including E-commerce, Vendor Managed Inventory and Vending programs tailored to overserve MRO, OEM, commercial contractor, and fabricator customers.</p>
      `,
      image: "/vendors/packer_fastener.webp",
      link: "https://www.packerfastener.com/"
    },
    {
      title: "Premier Components",
      content: `
        <h4>\u201CYour #1 Source for Mill Accessories\u201D</h4>
        <p>We carry a variety of mill accessories to meet your agricultural needs, including:</p>
        <ul class="list-disc">
          <li>Round and Square Spouting and Accessories, Including Round and Square Spout Patches</li>
          <li>Slide gates Standard, Premium and Heavy Duty options</li>
          <li>Valves and Valve Drives</li>
          <li>Round and Square Style Cushion Boxes original and \u201CNew Style\u201D option with Leak Free Design</li>
          <li>Distributors and Distributor Drives</li>
          <li>Urethane, Blue, Orange and Red along with UHMW</li>
          <li>Catwalks, Towers, Ladders and Grating</li>
          <li>Ductwork and Dust Control Components</li>
          <li>Bin Level Controls</li>
          <li>Hutchinson Bin Sweeps and Augers</li>
          <li>And much more!</li>
        </ul>
      `,
      image: "/vendors/premier_components.webp",
      link: "https://premier-com.com/"
    },
    {
      title: "Schlagel",
      content: `
      <p>\u201CManufacturing Material Handling Equipment For the Grain, Feed and Fertilizer Industries since 1957"</p>
      <p>Schlagel, Inc. has been an industry leader since 1957 in the design and manufacture of grain handling equipment. Their pioneering efforts have brought innovation to the industry\u2019s handling methods through enhancements to equipment design and increased machine capabilities/capacities.</p>`,
      image: "/vendors/schlagel.webp",
      link: "http://www.schlagel.com/"
    },
    {
      title: "Spread-All MFG",
      content: `
        <p>Our company is your best source for professional, value driven low cost service. Established in 1960 and family owned, we have decades of collective and comprehensive knowledge and experience. Meaning that we are able to provide the most value and innovation per your dollar spent. We provide a satisfaction guarantee for all services provided.</p>
      `,
      image: null,
      link: "http://www.spread-allmfg.net/"
    },
    {
      title: "Tapco",
      content: `
        <p>Tapco has spent nearly 30 years in its large St. Louis-area facility, which houses in-house injection molding capabilities to maximize quality and minimize costs. With a variety of injection molding machines, including a wide range of presses, Tapco has the equipment and the experience to find a solution for any elevator bucket need.</p>
      `,
      image: "/vendors/tapco.webp",
      link: "https://www.tapcoinc.com/"
    }
  ];
  $$result.css.add(css);
  return `${validate_component(FeaturedImage, "FeaturedImage").$$render($$result, {
    imageUrl: "'/vendors/featured_vendors.webp'",
    pageName: "Vendors",
    pageTagline: "Availability and Cost Savings"
  }, {}, {})}

<div class="${"w-screen flex justify-center"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg py-8"}"><div class="${"grid grid-cols-3"}">${each(vendors, (vendor, i) => `${i % 2 == 0 ? `<div class="${"flex justify-center items-center my-3"}"><a rel="${"external"}" target="${"_blank"}"${add_attribute("href", vendor.link, 0)}>${vendor.image ? `<img class="${"max-w-ninety max-h-32"}"${add_attribute("src", vendor.image, 0)}${add_attribute("alt", vendor.title, 0)}>` : `<h3>${escape(vendor.title)}</h3>`}
            </a></div>
          <div class="${"col-span-2 my-3"}"><h3 class="${"my-2"}"><a rel="${"external"}" target="${"_blank"}"${add_attribute("href", vendor.link, 0)}>${escape(vendor.title)}</a></h3>
            <div><!-- HTML_TAG_START -->${vendor.content}<!-- HTML_TAG_END --></div>
          </div>` : `<div class="${"col-span-2 my-3"}"><h3 class="${"my-2"}"><a rel="${"external"}" target="${"_blank"}"${add_attribute("href", vendor.link, 0)}>${escape(vendor.title)}</a></h3>
            <div><!-- HTML_TAG_START -->${vendor.content}<!-- HTML_TAG_END -->
            </div></div>
          <div class="${"flex justify-center my-3"}"><a rel="${"external"}" target="${"_blank"}"${add_attribute("href", vendor.link, 0)}>${vendor.image ? `<img class="${"max-w-ninety max-h-32"}"${add_attribute("src", vendor.image, 0)}${add_attribute("alt", vendor.title, 0)}>` : `<h3>${escape(vendor.title)}</h3>`}</a>
          </div>`}`)}</div></div></div>

${$$result.head += `${$$result.title = `<title>Vendors | MWM</title>`, ""}<meta name="${"description"}" content="${"MWM has relationships with leading industry part suppliers, which enables MWM to pass availability and savings to the customer."}" data-svelte="svelte-15zgihd"><meta name="${"robots"}" content="${"index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"}" data-svelte="svelte-15zgihd">`, ""}`;
});
...
var About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(FeaturedImage, "FeaturedImage").$$render($$result, {
    imageUrl: "'/featured-about.webp'",
    pageName: "ABOUT MWM",
    pageTagline: "History Rooted in Quality"
  }, {}, {})}


<div class="${"w-screen flex justify-center"}"><div class="${"w-full max-w-ninety lg:max-w-screen-lg py-8"}"><h3>History</h3>
    <p class="${"my-4"}">MWM (Midwest Welding &amp; Manufacturing), formerly both Jakel Company (1945 - 2003) and MGRF (Midwest General Repair &amp; Fabrication 2003 - 2021), has been a family owned and operated business since 1945. </p>
    <p class="${"my-4"}">Started, in small town Reeseville Wisconsin, as a welding, repair, and blacksmith shop, the Jakel Company ventured in plumbing &amp; heating in the early 1950s, and as a supplier and installer of feed mill equipment in the late 1950s. It was in the 1960s that the Jakel brand of feed and grain equipment was developed and retailed, and in 1969 the first Jakel Bulk Feed body truck was sold. During the 1970s the Jakel company also offered small engine building and repair and manufacturing of snowmobiles, but the primary focus remained with the fabrication, install and repair of feed &amp; grain equipment.</p>
    <p class="${"my-4"}">In 2003 the Jakel family sold the business to Jon Schrock, a former employee, who changed the name to Midwest General Repair &amp; Fabrication. Will Schrock, Jon\u2019s son, now works alongside his father and members of the Jakel family continue to fill key roles at MWM today. Jon, in 2016, began to turn over the company to Jacob \u201CZoom\u201D Neuman, grandson to the Jakel Company founders, and energetic leader in the industry. Zoom has more than a dozen years of experience in the service, manufacturing, and installation of feed and grain equipment.</p>
    <p class="${"my-4"}">MWM has continued to focus most of their efforts into honing skills and expertise in the area of equipment design, fabrication, and repair of feed and grain equipment. However, MWM has led many custom equipment design, repair, &amp; fabrication projects in various fields such as Feed Mills, Ethanol Plants, Milk Replacer Facilities, Egg Production Sites, Concrete Mixing Plants, a Drywall Mixing Plant, Fertilizer Plants, Conveyors &amp; Equipment for a State-owned Power Plant, Milorganite Bagging Plant, Carbon Bagging Facility and continues to reach into new scenes.</p>
    <p class="${"my-4"}">Many of our customers have experienced decades of both service and loyalty and we look forward to adding you to our family of satisfied customers.</p>

    <div class="${"grid grid-cols-3 gap-4"}"><img src="${"/jakel_logo.webp"}" alt="${"Jakel Co Logo"}" class="${"max-w-ninety mx-auto"}">
      <img src="${"/mgrf_logo.webp"}" alt="${"MGRF Logo"}" class="${"max-w-ninety mx-auto"}">
      <img src="${"/logo.webp"}" alt="${"MWM Logo"}" class="${"max-w-ninety mx-auto"}"></div></div></div>

${$$result.head += `${$$result.title = `<title>About | MWM</title>`, ""}<meta name="${"description"}" content="${"MWM is a custom agricultural equipment manufacturer with 75yrs of providing products and repair services to greater midwest."}" data-svelte="svelte-e5zqra"><meta name="${"robots"}" content="${"index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"}" data-svelte="svelte-e5zqra">`, ""}`;
});
